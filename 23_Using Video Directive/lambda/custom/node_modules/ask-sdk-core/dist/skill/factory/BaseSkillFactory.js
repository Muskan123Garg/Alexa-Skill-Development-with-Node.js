    ...
    BaseSkillFactory.init = function () {
        ...
        return {
            ...
            addRequestHandlers: function () {
                ...
                thisRequestHandlers.push.apply(thisRequestHandlers, requestHandlers);
                return this;
            },
            ...
            getSkillConfiguration: function () {
                var requestHandlerChains = [];
                for (var _i = 0, thisRequestHandlers_1 = thisRequestHandlers; _i < thisRequestHandlers_1.length; _i++) {
                    var requestHandler = thisRequestHandlers_1[_i];
                    requestHandlerChains.push(new DefaultRequestHandlerChain_1.DefaultRequestHandlerChain({
                ...
                var requestMapper = new DefaultRequestMapper_1.DefaultRequestMapper({
                    requestHandlerChains: requestHandlerChains,
                });
